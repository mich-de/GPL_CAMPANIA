...
android {
  ...
  // da chiunque (`assembleDebug` funziona sempre). Per firmare una release, esportare
  // KEYSTORE_PATH, STORE_PASSWORD, KEY_ALIAS e KEY_PASSWORD prima di `assembleRelease`.
